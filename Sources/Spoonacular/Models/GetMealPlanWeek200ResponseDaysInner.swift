...
public struct GetMealPlanWeek200ResponseDaysInner: Codable, JSONEncodable, Hashable {
    ...
    public init(date: Double, day: String, nutritionSummary: GetMealPlanWeek200ResponseDaysInnerNutritionSummary? = nil, nutritionSummaryBreakfast: GetMealPlanWeek200ResponseDaysInnerNutritionSummary? = nil, nutritionSummaryLunch: GetMealPlanWeek200ResponseDaysInnerNutritionSummary? = nil, nutritionSummaryDinner: GetMealPlanWeek200ResponseDaysInnerNutritionSummary? = nil, items: Set<GetMealPlanWeek200ResponseDaysInnerItemsInner>? = nil) {
        self.date = date
        self.day = day
