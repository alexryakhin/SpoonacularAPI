...
public struct GetProductInformation200Response: Codable, JSONEncodable, Hashable {
    ...
    public init(id: Int, title: String, breadcrumbs: [String], imageType: String, badges: [String], importantBadges: [String], ingredientCount: Int, ingredientList: String, ingredients: [GetProductInformation200ResponseIngredientsInner], likes: Double, aisle: String, nutrition: SearchGroceryProductsByUPC200ResponseNutrition, price: Double, servings: SearchGroceryProductsByUPC200ResponseServings, spoonacularScore: Double, generatedText: AnyCodable? = nil) {
        self.id = id
        self.title = title
