...
open class MealPlanningAPI {
    ...
    open class func addMealPlanTemplate(username: String, hash: String, addToMealPlanRequest: AddToMealPlanRequest) async throws -> AddMealPlanTemplate200Response {
        return try await addMealPlanTemplateWithRequestBuilder(username: username, hash: hash, addToMealPlanRequest: addToMealPlanRequest).execute().body
    }
    ...
    open class func addMealPlanTemplateWithRequestBuilder(username: String, hash: String, addToMealPlanRequest: AddToMealPlanRequest) -> RequestBuilder<AddMealPlanTemplate200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<AddMealPlanTemplate200Response>.Type = SpoonacularAPIAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func addToMealPlan(username: String, hash: String, addToMealPlanRequest: AddToMealPlanRequest) async throws -> AnyCodable {
        return try await addToMealPlanWithRequestBuilder(username: username, hash: hash, addToMealPlanRequest: addToMealPlanRequest).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func addToShoppingList(username: String, hash: String, addToMealPlanRequest: AddToMealPlanRequest) async throws -> GenerateShoppingList200Response {
        return try await addToShoppingListWithRequestBuilder(username: username, hash: hash, addToMealPlanRequest: addToMealPlanRequest).execute().body
    }
    ...
    open class func addToShoppingListWithRequestBuilder(username: String, hash: String, addToMealPlanRequest: AddToMealPlanRequest) -> RequestBuilder<GenerateShoppingList200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GenerateShoppingList200Response>.Type = SpoonacularAPIAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func clearMealPlanDay(username: String, date: String, hash: String, clearMealPlanDayRequest: ClearMealPlanDayRequest) async throws -> AnyCodable {
        return try await clearMealPlanDayWithRequestBuilder(username: username, date: date, hash: hash, clearMealPlanDayRequest: clearMealPlanDayRequest).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func connectUser(body: AnyCodable) async throws -> ConnectUser200Response {
        return try await connectUserWithRequestBuilder(body: body).execute().body
    }
    ...
    open class func connectUserWithRequestBuilder(body: AnyCodable) -> RequestBuilder<ConnectUser200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<ConnectUser200Response>.Type = SpoonacularAPIAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func deleteFromMealPlan(username: String, id: Double, hash: String, deleteFromMealPlanRequest: DeleteFromMealPlanRequest) async throws -> AnyCodable {
        return try await deleteFromMealPlanWithRequestBuilder(username: username, id: id, hash: hash, deleteFromMealPlanRequest: deleteFromMealPlanRequest).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func deleteFromShoppingList(username: String, id: Int, hash: String, deleteFromMealPlanRequest: DeleteFromMealPlanRequest) async throws -> AnyCodable {
        return try await deleteFromShoppingListWithRequestBuilder(username: username, id: id, hash: hash, deleteFromMealPlanRequest: deleteFromMealPlanRequest).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func deleteMealPlanTemplate(username: String, id: Int, hash: String, deleteFromMealPlanRequest: DeleteFromMealPlanRequest) async throws -> AnyCodable {
        return try await deleteMealPlanTemplateWithRequestBuilder(username: username, id: id, hash: hash, deleteFromMealPlanRequest: deleteFromMealPlanRequest).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func generateMealPlan(timeFrame: String? = nil, targetCalories: Double? = nil, diet: String? = nil, exclude: String? = nil) async throws -> GenerateMealPlan200Response {
        return try await generateMealPlanWithRequestBuilder(timeFrame: timeFrame, targetCalories: targetCalories, diet: diet, exclude: exclude).execute().body
    }
    ...
    open class func generateMealPlanWithRequestBuilder(timeFrame: String? = nil, targetCalories: Double? = nil, diet: String? = nil, exclude: String? = nil) -> RequestBuilder<GenerateMealPlan200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GenerateMealPlan200Response>.Type = SpoonacularAPIAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func generateShoppingList(username: String, startDate: String, endDate: String, hash: String, generateShoppingListRequest: GenerateShoppingListRequest) async throws -> GenerateShoppingList200Response {
        return try await generateShoppingListWithRequestBuilder(username: username, startDate: startDate, endDate: endDate, hash: hash, generateShoppingListRequest: generateShoppingListRequest).execute().body
    }
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getMealPlanTemplate(username: String, id: Int, hash: String) async throws -> GetMealPlanTemplate200Response {
        return try await getMealPlanTemplateWithRequestBuilder(username: username, id: id, hash: hash).execute().body
    }
    ...
    open class func getMealPlanTemplateWithRequestBuilder(username: String, id: Int, hash: String) -> RequestBuilder<GetMealPlanTemplate200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GetMealPlanTemplate200Response>.Type = SpoonacularAPIAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getMealPlanTemplates(username: String, hash: String) async throws -> GetMealPlanTemplates200Response {
        return try await getMealPlanTemplatesWithRequestBuilder(username: username, hash: hash).execute().body
    }
    ...
    open class func getMealPlanTemplatesWithRequestBuilder(username: String, hash: String) -> RequestBuilder<GetMealPlanTemplates200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GetMealPlanTemplates200Response>.Type = SpoonacularAPIAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getMealPlanWeek(username: String, startDate: String, hash: String) async throws -> GetMealPlanWeek200Response {
        return try await getMealPlanWeekWithRequestBuilder(username: username, startDate: startDate, hash: hash).execute().body
    }
    ...
    open class func getMealPlanWeekWithRequestBuilder(username: String, startDate: String, hash: String) -> RequestBuilder<GetMealPlanWeek200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GetMealPlanWeek200Response>.Type = SpoonacularAPIAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @available(macOS 10.15, iOS 13.0, tvOS 13.0, watchOS 6.0, *)
    open class func getShoppingList(username: String, hash: String) async throws -> GetShoppingList200Response {
        return try await getShoppingListWithRequestBuilder(username: username, hash: hash).execute().body
    }
    ...
    open class func getShoppingListWithRequestBuilder(username: String, hash: String) -> RequestBuilder<GetShoppingList200Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<GetShoppingList200Response>.Type = SpoonacularAPIAPI.requestBuilderFactory.getBuilder()
