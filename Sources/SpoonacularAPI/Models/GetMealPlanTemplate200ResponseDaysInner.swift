...
public struct GetMealPlanTemplate200ResponseDaysInner: Codable, JSONEncodable, Hashable {
    ...
    public init(day: String, nutritionSummary: GetMealPlanWeek200ResponseDaysInnerNutritionSummary? = nil, nutritionSummaryBreakfast: GetMealPlanWeek200ResponseDaysInnerNutritionSummary? = nil, nutritionSummaryLunch: GetMealPlanWeek200ResponseDaysInnerNutritionSummary? = nil, nutritionSummaryDinner: GetMealPlanWeek200ResponseDaysInnerNutritionSummary? = nil, items: Set<GetMealPlanTemplate200ResponseDaysInnerItemsInner>? = nil) {
        self.day = day
