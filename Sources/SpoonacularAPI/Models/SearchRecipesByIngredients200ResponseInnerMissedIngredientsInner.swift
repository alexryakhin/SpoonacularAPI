...
public struct SearchRecipesByIngredients200ResponseInnerMissedIngredientsInner: Codable, JSONEncodable, Hashable {
    ...
    public init(aisle: String, amount: Double, id: Int, image: String, name: String, original: String, originalName: String, unit: String, unitLong: String, unitShort: String, meta: [String]? = nil) {
        self.aisle = aisle
        self.amount = amount
        self.id = id
        self.image = image
