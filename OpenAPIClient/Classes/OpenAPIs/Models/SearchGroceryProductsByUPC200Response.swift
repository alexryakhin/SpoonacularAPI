...
public struct SearchGroceryProductsByUPC200Response: Codable, JSONEncodable, Hashable {
    ...
    public init(id: Int, title: String, badges: [String], importantBadges: [String], breadcrumbs: [String], generatedText: String, imageType: String, ingredientCount: Int? = nil, ingredientList: String, ingredients: Set<SearchGroceryProductsByUPC200ResponseIngredientsInner>, likes: Double, nutrition: SearchGroceryProductsByUPC200ResponseNutrition, price: Double, servings: SearchGroceryProductsByUPC200ResponseServings, spoonacularScore: Double) {
        self.id = id
        self.title = title
        self.badges = badges
