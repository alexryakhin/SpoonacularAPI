...
public struct GetRandomRecipes200ResponseRecipesInner: Codable, JSONEncodable, Hashable {
    ...
    public init(id: Int, title: String, image: String, imageType: String, servings: Double, readyInMinutes: Int, license: String, sourceName: String, sourceUrl: String, spoonacularSourceUrl: String, aggregateLikes: Double, healthScore: Double, spoonacularScore: Double, pricePerServing: Double, analyzedInstructions: [AnyCodable]? = nil, cheap: Bool, creditsText: String, cuisines: [String]? = nil, dairyFree: Bool, diets: [String]? = nil, gaps: String, glutenFree: Bool, instructions: String, ketogenic: Bool, lowFodmap: Bool, occasions: [String]? = nil, sustainable: Bool, vegan: Bool, vegetarian: Bool, veryHealthy: Bool, veryPopular: Bool, whole30: Bool, weightWatcherSmartPoints: Double, dishTypes: [String]? = nil, extendedIngredients: Set<GetRecipeInformation200ResponseExtendedIngredientsInner>? = nil, summary: String, winePairing: GetRecipeInformation200ResponseWinePairing? = nil) {
        self.id = id
        self.title = title
        self.image = image
