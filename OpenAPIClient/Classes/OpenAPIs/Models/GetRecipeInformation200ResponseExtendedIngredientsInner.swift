...
public struct GetRecipeInformation200ResponseExtendedIngredientsInner: Codable, JSONEncodable, Hashable {
    ...
    public init(aisle: String, amount: Double, consitency: String, id: Int, image: String, measures: GetRecipeInformation200ResponseExtendedIngredientsInnerMeasures? = nil, meta: [String]? = nil, name: String, original: String, originalName: String, unit: String) {
        self.aisle = aisle
        self.amount = amount
